<section class="modal">
    ...
    <form method="post">
        ...
        <label >
            Archivos
            <input class="inputs-modal" placeholder="Ingrese un archivo" type="text" name="archivo" >
        </label>
...
&& strlen($_POST['hora']) >0  && strlen($_POST['aula']) >0 && ($aula == $aula_entero) && strlen($_POST['archivo']) >= 0 && strlen($_POST['temas']) >= 0  && strlen($_POST['novedad']) >= 0)  { 
    ...
    $consulta = "INSERT INTO clases(CODIGO_USUARIO,CODIGO_MATERIA,COMISION,FECHA,HORA,AULA,ARCHIVOS,TEMAS,NOVEDADES) VALUES 
                                    ('$id_usuario','$materia','$comision','$fecha','$hora','$aula','$archivo','$temas','$novedad')";  
